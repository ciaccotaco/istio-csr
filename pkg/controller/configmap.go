...
func AddConfigMapController(ctx context.Context, log logr.Logger, opts Options) error {
	...
	maxConcurrentReconciles := max(opts.MaxConcurrentReconciles, 1)
	log.Info("maxConcurrentReconciles", "value", maxConcurrentReconciles)
	...
	return ctrl.NewControllerManagedBy(opts.Manager).
		// Controls how many ConfigMaps can reconcile in parallel
